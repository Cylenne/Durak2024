...
public class GameRulesScreen extends JDialog {
    ...
    public GameRulesScreen(JFrame parentFrame) {
        ...
        String gameRulesText = "Game Rules:\n\n" +
                ...
                "9. If the defender cannot beat the attacking cards, they must pick up all the cards on the table and their chance to launch an initial attack is skipped.\n" +
