...
public class GameRulesScreen extends JDialog {
    ...
    public GameRulesScreen(JFrame parentFrame) {
        ...
        String gameRulesText = "Game Rules:\n\n" +
                ...
                "2. The game can have 2 to 6 players.\n" +
                ...
                "6. The defender must beat the attacking cards with higher cards of the same suit or any trump card.\n" +
                "7. If the defender cannot beat the attacking cards, they must pick up all the cards on the table.\n" +
                "8. The game continues until all cards are played or only one player has cards left.\n\n" +
                "Enjoy playing Durak!";
